...
public static class SpecSheetsUploadValidation
{
    ...
    public static string Run()
    {
        ...
        t_formula["sheets"][0]["data"][0]["rowData"][2]["values"][1] = new JObject {
        ...
        Check((int)t_plan.Requests[0]["updateCells"]["range"]["startRowIndex"] == 2 &&
        ...
        Check(t_clear.CanUpload && t_clear.ChangedCellCount == 5, "trailing row and column values cleared");
