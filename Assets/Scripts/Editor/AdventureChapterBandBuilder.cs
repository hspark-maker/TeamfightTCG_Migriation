...
public static class AdventureChapterBandBuilder
{
    const string PREFAB_PATH = "Assets/Assets/Prefabs/UI/LobbyUI/Adventure/ChapterBand.prefab";
    ...
    public static void Build()
    {
        ...
        // ⚠ 루트의 anchoredPosition은 맵이 '이음매로부터의 오프셋'으로 읽는다(AdventureMapOverlayView.bandPrefab 참고).
        ...
        var t_view  = t_root.AddComponent<AdventureChapterBandView>();
    ...
    static void Wire(AdventureChapterBandView _view, TMP_Text _title, TMP_Text _progress, Button _claim,
