...
///  2   Placed         BattleFieldState 초기 배치       동기 완결. **등장 아님**
...
/// 13   Entered        BattleFieldState 런타임 등장      동기 완결
/// 14   AfterAttack    AttackFlow (연출 후)             await. defenderKilled 포함
/// 15   BoardChanged   BattleFieldState 보드 구성 변화   동기 void. 아래 ※
///
/// ※ BoardChanged: 필드의 **라이브 카드 구성이 바뀔 때마다** 발화한다(배치 확정 / 등장 / 제거).
///   "필드의 X 수만큼"처럼 보드를 세서 파생 상태를 유지해야 하는 효과가 쓴다.
///   발화점은 전부 BattleFieldState 안이다 — ApplyDeckSynergy / NotifyEntered / RemoveCard.
///
...
public readonly struct SpawnCtx
{
    ...
    public readonly BattleFieldState field;
    public readonly SynergyRuntime synergy;
    public SpawnCtx(CardInstance _self, BattleFieldState _field, SynergyRuntime _synergy = null)
...
public readonly struct BoardCtx
{
    ...
    public readonly CardInstance self;
    public readonly SynergyRuntime synergy;
    public BoardCtx(BattleFieldState _field, CardInstance _self = null, SynergyRuntime _synergy = null)
...
public readonly struct TurnCtx
{
    ...
    public readonly BattleFieldState field;
    public readonly SynergyRuntime synergy;
    public TurnCtx(CardInstance _self, BattleFieldState _field, SynergyRuntime _synergy = null)
    { this.self = _self; this.field = _field; this.synergy = _synergy; }
...
public readonly struct BeforeAttackCtx
{
    ...
    public readonly BattleFieldState ownField;
    public readonly BattleFieldState enemyField;
    public readonly SynergyRuntime synergy;
    public BeforeAttackCtx(CardInstance _self, CardInstance _defender,
                           BattleFieldState _ownField, BattleFieldState _enemyField, SynergyRuntime _synergy = null)
...
public readonly struct DamageDealtCtx
{
    ...
    public readonly SynergyRuntime synergy;
    public DamageDealtCtx(CardInstance _self, BattleFieldState _field, int _damage, bool _isRetaliation,
...
public readonly struct DeathCtx
{
    ...
    public readonly BattleFieldState field;
    public readonly SynergyRuntime synergy;
    public DeathCtx(CardInstance _self, BattleFieldState _field, SynergyRuntime _synergy = null)
    { this.self = _self; this.field = _field; this.synergy = _synergy; }
...
public readonly struct SwapOutCtx
{
    ...
    public readonly BattleFieldState field;
    public readonly SynergyRuntime synergy;
    public SwapOutCtx(CardInstance _self, CardInstance _incoming, BattleFieldState _field, SynergyRuntime _synergy = null)
...
public readonly struct AfterAttackCtx
{
    ...
    public readonly SynergyRuntime synergy;
    public AfterAttackCtx(CardInstance _self, CardInstance _target, BattleFieldState _ownField, BattleFieldState _enemyField,
