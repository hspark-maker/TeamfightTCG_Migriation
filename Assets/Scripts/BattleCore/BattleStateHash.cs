...
///
/// <para><b>정렬 규칙</b>: 두 필드를 <see cref="BattleFieldState.OwnerIndex"/> 오름차순으로 접는다.
...
public static class BattleStateHash
{
    ...
    public static ulong Compute(BattleFieldState _a, BattleFieldState _b)
    {
        OrderByOwner(_a, _b, out BattleFieldState t_first, out BattleFieldState t_second);
    ...
    public static string Dump(BattleFieldState _a, BattleFieldState _b)
    {
        OrderByOwner(_a, _b, out BattleFieldState t_first, out BattleFieldState t_second);
    ...
    static void OrderByOwner(BattleFieldState _a, BattleFieldState _b,
        out BattleFieldState _first, out BattleFieldState _second)
    {
    ...
    static void FoldField(ref ulong _hash, BattleFieldState _field)
    {
    ...
    static void DumpField(StringBuilder _builder, BattleFieldState _field)
    {
