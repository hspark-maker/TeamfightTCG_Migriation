...
public static class SpecPayloadCodec
{
    ...
    /// <para><c>CosmeticItem</c> — CSV에서 발행하는 외형 지급·기본 소유 카탈로그다.</para>
    ///
    /// <para>목록으로 거르는 이유는 <see cref="ServerOwnedRewardOwners"/> 와 같다 — 통째로 조용히
    /// 만들면 진짜로 빠뜨린 표까지 묻힌다. 제외는 이름을 적는 의도적 행위여야 한다.</para>
    /// </summary>
    public static readonly string[] ServerOnlyTableNames = { "Mission", "RankAiEncounter", "Achievement", "CardCraft", "CosmeticItem", "Title" };
