...
/// <see cref="TournamentProgress.TryBackfillSeenUnlocks"/> 가 진행 흔적을 보고 조용히 소급 표식한다.</para></summary>
public static class TournamentUnlockSeenStore
{
    const string PREFS_KEY = "outgame.tournament.seenUnlocks";
