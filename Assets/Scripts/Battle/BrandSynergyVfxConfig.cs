...
/// <summary>낙인 시너지 연출. 엠블럼(베이스) + 선피해 투사체.
/// 투사체 프리팹이 비어 있으면 볼리는 통째로 생략된다 — 피해는 이미 적용된 뒤라 연출은 선택이다.</summary>
[CreateAssetMenu(fileName = "BrandSynergyVfx", menuName = "Card Battle/Synergy Vfx/Brand")]
public class BrandSynergyVfxConfig : SynergyVfxConfig
{
    [Header("선피해 투사체")]
