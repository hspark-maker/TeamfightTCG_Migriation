...
public class MatchDeckShell : MonoBehaviour
{
    ...
    public void Confirm()
    {
        ...
        // 안내 밖 경로로 정점 전투에 나가도 모험 소개는 목적을 이룬 것이다 — 낙인을 찍어 다음에 다시 부르지 않는다.
        if (AdventureRun.IsActive) OutgameTutorialRunner.FinishGuided(EOutgameTutorialTrigger.AdventureMapFirstOpen);
