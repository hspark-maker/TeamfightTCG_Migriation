...
/// <summary>
/// 코드 빌드 튜토리얼 UI 공용 스타일. 폰트는 Resources의 MalgunGothic_TMP 단일 진실원.
/// (튜토리얼 UI는 프리팹 없이 코드로 텍스트를 만들어 인스펙터로 폰트를 못 꽂으므로 여기서 일괄 적용.)
/// </summary>
public static class TutorialUIStyle
{
    const string FontResourcePath = "Fonts/MalgunGothic_TMP";
    static TMP_FontAsset s_font;

    static TMP_FontAsset Font =>
        s_font != null ? s_font : (s_font = Resources.Load<TMP_FontAsset>(FontResourcePath));
