...
public class EmoteEditDragController : MonoBehaviour
{
    ...
    public void Initialize(RectTransform _layer, IReadOnlyList<EmoteItemCell> _slots, Action<int, int, int> _onDropped)
    {
        this.m_layer = _layer;
    ...
    {
        this.Cancel();
        if (this.m_layer == null || _source == null || _source.EmoteId <= 0 || _pointer == null) return;
