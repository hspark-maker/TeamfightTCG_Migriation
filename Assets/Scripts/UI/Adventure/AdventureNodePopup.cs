...
public class AdventureNodePopup : PooledUIBase
{
    ...
    [Tooltip("상대 초상. AdventureNodeDef.avatar가 비어 있으면 프리팹에 저작된 그림을 그대로 둔다(정점 표현과 같은 규약).")]
    ...
    public override void Initialization(UIData _data)
    {
        ...
        if (_data is AdventureNodePopupData t_d)
        {
    ...
    void Bind(int _index)
    {
        ...
        AdventureProgress.FillRewards(_index, this.m_rewards);
...
public class AdventureNodePopupData : UIData
{
