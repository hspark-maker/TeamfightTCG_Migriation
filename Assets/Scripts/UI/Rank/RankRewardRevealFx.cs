...
[System.Serializable]
public class RankRewardRevealFx
{
    [Header("빛")]
    ...
    [Tooltip("2종 이상일 때의 배율. 1로 두면 행이 화면 폭의 80%를 넘겨 '나열'로 읽힌다.")]
    ...
    public void ApplyCount(int _count)
    {
        ...
        this.rewardRow.localScale = Vector3.one * (_count <= 1 ? this.soloScale : this.duoScale);
    }
