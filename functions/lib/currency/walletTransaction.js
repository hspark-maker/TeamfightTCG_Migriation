 ...
 */
async function mutateWallet(command, env, uid, mutate) {
    ...
    return (0, countedTransaction_1.withCountedTransaction)(command, async (transaction) => {
        ...
        const next = mutate((0, walletStore_1.readWallet)(snapshot));
        (0, walletStore_1.writeWallet)(transaction, reference, next, firestore_1.FieldValue.serverTimestamp());
