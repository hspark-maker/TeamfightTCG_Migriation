...
exports.readPackGrants = readPackGrants;
exports.writePackGranted = writePackGranted;
exports.clearGrants = clearGrants;
 ...
 * @return {void}
 */
function writeGrantUsed(transaction, ref, axis, now) {
    transaction.set(ref, {
 ...
 */
function writePackGranted(transaction, ref, packId, now) {
    if (packId === "" || packId.startsWith("__") || packId.includes("/"))
        return false;
    transaction.set(ref, {
        schemaVersion: exports.GRANT_SCHEMA_VERSION,
        packs: { [packId]: true },
 ...
 * @return {void}
 */
function clearGrants(transaction, ref) {
