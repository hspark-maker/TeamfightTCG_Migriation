import {CosmeticItem, ensureCosmeticOwnership} from "../profile/cosmetics";
...
export function buildFreshAccountSlots(
  ...
  cosmetics: readonly CosmeticItem[] = [],
): SlotPatch {
  const slots = [];
  ...
  return {
    ...
    profile: ensureCosmeticOwnership(
      {nickname, avatarId: null, frameId: null, accountExp: 0, accountRewardLevel: 1}, cosmetics),
