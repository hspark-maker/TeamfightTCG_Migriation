// AdventureChapter 표 해석 — 챕터 완주의 **모수**와 정점 해금의 **사슬**을 함께 낸다.
...
/**
 * AdventureChapter 시트 한 줄. 컬럼 이름을 그대로 쓴다
...
/**
 * AdventureChapter 표를 읽는다. 챕터·정점 키가 빈 줄은 버린다.
 *
 ...
 * @param {ChapterNodeRow[]} rows AdventureChapter 표 전량
